...
const menuItems = [
  ...
  { label: "Account", href: "/teacher/account", icon: UserCircle2 },
];
    ...
    <>
      ...
      >
        <div className="mb-6 px-2">
          ...
          <h1 className="mt-1 text-lg font-semibold text-white">Teacher</h1>
        </div>
        ...
        <nav className="space-y-1.5">
          {menuItems.map((item) => {
            const isClassesRoute = item.href === "/teacher/classes";
